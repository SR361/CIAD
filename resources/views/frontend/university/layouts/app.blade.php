...
<body>
    @include('frontend.university.layouts.sidebar')
    <!-- Start Welcome area -->
    <div class="all-content-wrapper">
        ...
        @include('frontend.university.layouts.header')
        @yield('section')

    </div>
    @include('frontend.university.layouts.footer')
